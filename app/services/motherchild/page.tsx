...
const keyServices = [
  {
    ...
    items: ["Antenatal check-ups and monitoring", "High-risk pregnancy management", "Normal and caesarean delivery", "Postnatal care and lactation support"],
  },
  {
    category: "Gynaecological Care",
    items: ["Routine gynaecological check-ups", "Fertility and menstrual disorder evaluation", "Laparoscopic gynaecological surgery", "Menopause management"],
  },
  {
    category: "Paediatric Care",
    items: ["Newborn and infant check-ups", "Vaccination and growth monitoring", "Common childhood illness management", "Paediatric emergency care"],
  },
  {
    category: "Newborn & NICU Care",
    items: ["Neonatal intensive care (NICU)", "Premature and low-birth-weight care", "Newborn screening", "Round-the-clock neonatology support"],
  },
];

export const metadata = {
  title: "Mother & Child | Hopewell Hospital Ranchi",
  description:
    "Sensitive obstetric, gynaecological, paediatric and newborn care at Hopewell Hospital, supporting families through every stage from pregnancy to childhood.",
};
  ...
  return (
    <main className="min-h-screen bg-[#edf9f8]">
      ...
      <section
        ...
        style={{ backgroundImage: "url(/mothchild.jfif)" }}
      >
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-20">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-center font-bold text-slate-500">
          Sensitive obstetric, gynaecological, paediatric and newborn care, supporting families
          through every stage from pregnancy to childhood.
        </p>
        ...
        <a
          href="/appointment?specialty=Mother%20%26%20Child"
          target="_blank"
